...
;(function ( $, window, document, undefined ) {
  ...
  $(document).ready( function() {
    ...
    $('.cs-groups').CSFRAMEWORK_RELOAD_WYSIWYG();//Add by Quang (18/6/2018)
    $('.cs-add-group').on('click', function(e) {
    	e.preventDefault();
	 	$('.cs-groups').CSFRAMEWORK_RELOAD_WYSIWYG();
    });
